...
var imgCallback = function (img) {
    ...
    //document.getElementById("testimg").firstElementChild.appendChild(img);
};
...
var urlimg = "http://192.168.0.108:8080/test/images/test.jpg";
var urlaudio ="http://192.168.0.108:8080/test/gun.ogg";

function load_img(){
    load_asset_image(urlimg,imgCallback,errorCallback);
    //if(document.getElementById("testimg").firstElementChild==null){
    //    console.log("发现标签");
    //    document.getElementById("testimg").firstElementChild.appendChild(load_asset_image);
    //    document.getElementById("testimg").appendChild()
    //
    //}
    if(document.getElementById("testimg")!=null){
        console.log("找到标签");
        document.getElementById("testimg").removeChild();
    }
}
function load_audio(){
